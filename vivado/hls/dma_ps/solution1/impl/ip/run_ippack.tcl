...
set Library     "hls"
set IPName      "acti_proc"
set Version     "1.0"
set DisplayName "Acti_proc"
set Revision    "2113506108"
...
set xo_kernel_name "acti_proc"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/bitstreambard/dma_ps/hls/dma_ps/solution1"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "/home/bitstreambard/dma_ps/hls/dma_ps/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {acti_proc_flow_control_loop_pipe_sequential_init
...
set kernel_xo ""
set detect_deadlock_json "acti_proc_message_dict.json"

## Variables
set Top "acti_proc"
set TopNoPrefix "acti_proc"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_imem m_axi_mem"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_imem {
        ...
        data_width "64"
        port_prefix "m_axi_imem"
        param_prefix "C_M_AXI_IMEM"
