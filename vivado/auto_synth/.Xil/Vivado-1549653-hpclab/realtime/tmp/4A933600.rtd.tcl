...
set genomeRtd $env(RT_TMP)/4A933600.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {acti_proc_matmul_Pipeline_VITIS_LOOP_51_8__GB0}]"
...
set genomeName [subst -nocommands -novariables {acti_proc_matmul_Pipeline_VITIS_LOOP_51_8__GB0}]
