...
set genomeRtd $env(RT_TMP)/10EF5D760.rtd
...
rt::set_parameter parallelChildUpdateCell true; rt::set_parameter parallelTimingMode true; rt::set_parameter parallelTimingModeRound 1; set rt::SDCFileList ./.Xil/Vivado-1549653-hpclab/realtime/design_1_synth.xdc; 
