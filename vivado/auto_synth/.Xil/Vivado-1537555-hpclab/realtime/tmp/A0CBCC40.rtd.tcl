...
set genomeRtd $env(RT_TMP)/A0CBCC40.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {acti_proc__GCB0}]"
...
set genomeName [subst -nocommands -novariables {acti_proc__GCB0}]
