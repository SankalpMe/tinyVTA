...
set genomeRtd $env(RT_TMP)/4C4540C0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {acti_proc_matmul__GCB0}]"
...
set genomeName [subst -nocommands -novariables {acti_proc_matmul__GCB0}]
