...
set genomeRtd $env(RT_TMP)/1148DAE00.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {design_1_acti_proc_0_0_GT3__2}]"
...
set genomeName [subst -nocommands -novariables {design_1_acti_proc_0_0_GT3__2}]
