...
set genomeRtd $env(RT_TMP)/83615CA0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {design_1_axi_smc_0}]"
...
set genomeName [subst -nocommands -novariables {design_1_axi_smc_0}]
