...
set genomeRtd $env(RT_TMP)/4C2C27C0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {acti_proc_matmul__GCB3}]"
...
set genomeName [subst -nocommands -novariables {acti_proc_matmul__GCB3}]
